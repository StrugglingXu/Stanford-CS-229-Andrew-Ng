...
$\begin{aligned} \eta &= \left[ \begin{array}{cc|c} \log (\phi _1/\phi _k)\ \log (\phi _2/\phi _k)\ \vdots \ \log (\phi _{k-1}/\phi _k)\ \end{array} \right]\ a(\eta) &= -\log (\phi _k)\ b(y) &= 1\ \end{aligned}$
